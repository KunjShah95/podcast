    ...
    <div className="min-h-screen bg-[#0F1419]">
      ...
      <div className="flex pt-20">
        ...
        <div className="hidden lg:block lg:w-1/2 relative">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1589903308904-1010c2294adc?w=1200&h=1600&fit=crop')] bg-cover bg-center opacity-30" />
              ...
              <ul className="space-y-4">
                {features.map((feature) => (
                  <li key={feature} className="flex items-center gap-3 text-white/80">
                    <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#FF6B35]/20 text-[#FF6B35]">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="text-white/50">
                Start listening to millions of podcasts today
              </p>
            </div>
            ...
            <p className="mt-8 text-center text-white/50">
              ...
              <Link href="/login" className="text-[#FF6B35] font-semibold hover:text-[#FF8A4D] transition-colors">
                Sign in
              </Link>
            </p>
          </div>
